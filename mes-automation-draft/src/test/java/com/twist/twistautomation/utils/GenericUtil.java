...
public class GenericUtil {
	...
	public static String getPDFContent(String invoiceUrl) throws IOException {
		URL pdfUrl = new URL(invoiceUrl);
		InputStream inputStream = pdfUrl.openStream();
		BufferedInputStream pdfFileParse = new BufferedInputStream(inputStream);
		PDDocument document = PDDocument.load(pdfFileParse);
		String pdfContent = new PDFTextStripper().getText(document);



		FileWriter writer= new FileWriter("src/test/resources/invoice.txt");
